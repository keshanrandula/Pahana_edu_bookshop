...
//   return (
//     <div className="min-h-screen flex items-center justify-center bg-gradient-to-tr from-orange-100 to-orange-300 p-6">
...
const AddBook = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-tr from-white-100 to-white-200 p-6">
      <div className="w-full max-w-xl bg-white shadow-xl rounded-3xl p-8 text-orange-900">
        <h2 className="text-3xl font-bold text-center mb-6">📘 Add a New Book</h2>

        {message && (
          <div className="text-center mb-4 text-orange-700 font-semibold">
            {message}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium mb-1">Category</label>
            <div className="relative">
              <FiFileText className="absolute left-3 top-1/2 -translate-y-1/2 text-orange-400" />
              <select
                name="category"
                value={formData.category}
                onChange={handleChange}
                required
                className="w-full pl-10 pr-4 py-2.5 bg-orange-50 border border-orange-200 rounded-lg text-orange-900 focus:outline-none focus:ring-2 focus:ring-orange-400"
              >
                <option value="">Select Category</option>
                <option value="Fiction">Fiction</option>
                <option value="Non-Fiction">Non-Fiction</option>
        ...
        <div className="mt-6 text-center text-sm text-orange-700">
          <a href="/books" className="text-orange-600 hover:underline font-medium">
            📖 View All Books
          </a>
        </div>
      </div>
