...
//   return (
//     <div className="min-h-screen flex items-center justify-center bg-orange-to-br from-orange-50 to-indigo-100 p-6">
//       <ToastContainer />
//       <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md border border-orange-100 transform transition-all hover:shadow-2xl">
//         <div className="flex justify-center mb-6">
//           <div className="relative">
//             <div className="w-20 h-20 rounded-full bg-gradient-to-r from-orange-400 to-indigo-600 flex items-center justify-center text-white text-2xl font-bold">
...
//               <button
//                 onClick={() => setIsEditing(true)}
//                 className="flex-1 bg-gradient-to-r from-orange-500 to-indigo-600 text-white py-2 rounded-lg hover:from-orange-600 hover:to-indigo-700 transition duration-300 shadow-md flex items-center justify-center"
//               >
...
//               <button
//                 type="submit"
//                 className="flex-1 bg-gradient-to-r from-orange-500 to-teal-500 text-white py-2 rounded-lg hover:from-orange-600 hover:to-teal-600 transition duration-300 shadow-md flex items-center justify-center"
//               >
//                 <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
